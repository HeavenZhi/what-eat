...
CREATE TABLE `ingredient_kind` (
  ...
  `sid` int(11) NOT NULL COMMENT '食材类别表唯一键',
...
CREATE TABLE `ingredient_template` (
  ...
  `sid` int(11) NOT NULL COMMENT '食材模板表唯一键',
  ...
  `ik_sid` int(11) DEFAULT NULL COMMENT 'ingredient_kind表的sid外键',
  UNIQUE (`sid`),
  INDEX (`is_del`)
...
CREATE TABLE `ingredient_type` (
  ...
  `sid` int(11) NOT NULL COMMENT '食材类型表唯一键',
...
CREATE TABLE `ingredient` (
  ...
  `sid` int(11) NOT NULL COMMENT '食材表唯一键',
  `name` varchar(255) NOT NULL COMMENT '食材名称',
  `fid` int(11) DEFAULT NULL COMMENT '上级id',
  `ik_sid` int(11) DEFAULT NULL COMMENT 'ingredient_kind表的sid外键',
  `it_sid` int(11) DEFAULT NULL COMMENT 'ingredient_type表的sid外键',
  `process_difficulty` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '食材处理过程分值,加分越多处理越麻烦,加分越少处理越简单',
  `health` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '食材的清淡程度分值,加分越多越重口味,加分越少越清淡',
  UNIQUE (`sid`),
  INDEX (`is_del`)
...
CREATE TABLE `cuisine` (
  ...
  `sid` int(11) NOT NULL COMMENT '菜系分类表唯一键',
...
CREATE TABLE `dishes_type` (
  ...
  `sid` int(11) NOT NULL COMMENT '菜品分类表唯一键',
...
INSERT INTO `dishes_type`(sid,name,description) VALUES (6,'油炸菜','炸，是将原料挂糊(上浆)或不挂糊(不上浆)，放在不同温度的多量油锅中来加热成熟的烹饪技法。在炸原料时，油量要多于主料，是主料的2～3倍，有时甚至更多。油量大，炸得快，而且成菜效果好。常见的方法有清炸、干炸、软炸、松炸、酥炸、脆炸、泼炸、浸炸、卷炸等。虽说方法多多，但常用的还是前几种。');
...
CREATE TABLE `cookbook` (
  ...
  `sid` int(11) NOT NULL COMMENT '菜谱表唯一键',
  `name` varchar(50) NOT NULL COMMENT '菜名',
  `raptatorial` int(1) NOT NULL COMMENT '荤素,荤为1,素为0',
  `process_difficulty` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '食材处理过程分值,加分越多处理越麻烦,加分越少处理越简单',
  `health` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '食材的清淡程度分值,加分越多越重口味,加分越少越清淡',
  `cuisine_sid` int(11) NOT NULL COMMENT 'cuisine表的sid外键',
  `dt_sid` int(11) NOT NULL COMMENT 'dishes_type表的sid外键',
  UNIQUE (`sid`),
  INDEX (`is_del`)
...
CREATE TABLE `cookbook_details` (
  ...
  `sid` int(11) NOT NULL COMMENT '菜谱详情表唯一键',
  `c_sid` int(11) NOT NULL COMMENT 'cookbook表的sid外键',
...
CREATE TABLE `cookbook_details_ingredient` (
  ...
  `sid` int(11) NOT NULL COMMENT '菜谱和食材对照表唯一键',
  `quantity` varchar(50) NOT NULL COMMENT '食材用量',
  `cd_sid` int(11) NOT NULL COMMENT 'cookbook_details表的sid外键',
  `i_sid` int(11) NOT NULL COMMENT 'ingredient表的sid外键',
  UNIQUE (`sid`),
  INDEX (`is_del`)
...
CREATE TABLE `cooking_health` (
  ...
  `sid` int(11) NOT NULL COMMENT '烹饪难度和健康程度打分表唯一键',
...
CREATE TABLE `cookbook_details_cooking` (
  ...
  `sid` int(11) NOT NULL COMMENT '菜品详情和操作流程对应表唯一键',
  `description` text NOT NULL COMMENT '食材处理描述',
  `process_difficulty` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '食材处理过程分值,加分越多处理越麻烦,加分越少处理越简单',
  `health` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '食材的清淡程度分值,加分越多越重口味,加分越少越清淡',
  `cd_sid` int(11) NOT NULL COMMENT 'cookbook_details表的sid外键',
  `ch_sid` int(11) NOT NULL COMMENT 'cooking_health表的sid外键',
  UNIQUE (`sid`),
  INDEX (`is_del`)
